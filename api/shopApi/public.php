...
function purchace()
{
	...
	$api		= "https://api.hitbtc.com/api/2/public/ticker/DASHUSD";
	$datas2		= getFromUrl($api);

	$btc_json2	= json_decode($datas2, true);
	$btc_price2 = $btc_json2['last'];
	?>
	<form name='purfrm' method='post' action='purchase_ok.php'>
	<input type='hidden' name='dashbl' value="<?=$json_balance['pdash']?>">
		...
		<div id="container"><!--container-->
			<div class="wrap_trans"><!--wrap_trans-->
				...
				<div class="coin_state">
					<div>
						<span class="txt_tit" style="border-bottom: 1px solid #bfbcbc; width: 70%; margin: 0 auto; padding-bottom: 5px;margin-bottom: 5px;">Withdrawal Dash Balance</span>
						<span class="txt_num"><?=$json_balance['pdash']?></span>
					</div>
				</div>
				<div class="form01" style="margin-top:30px">
					<img src="images/setup_icon03.png" class="img01">
					<p class="account">Dash 시세</p>
				</div>
				<div class="form02">

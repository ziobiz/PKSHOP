...
class Database {
	...
	public function insert($query,$array=array(),$type="key",$table){
	...
	public function delete($query,$array=array(),$type="key",$table){
	...
	public function update($query,$array=array(),$type="key",$table){

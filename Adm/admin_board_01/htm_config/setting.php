...
$url_editor="http://www.mall.coalcobalt.com/Adm/admin_board_01/data";


$Board_Title = "공지사항"; //게시판이름
if($Sub_No=='1'){
	$Board_Title = "공지사항";
}else if($Sub_No=='2'){
	$Board_Title = "질문과답변";
...
$email_part="<img src=./img/send_mail.gif border=0 align=middle>";

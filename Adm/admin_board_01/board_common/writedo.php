<? 
	...
	include '../admin/admin_board_01/htm_config/setting.php';
...
if (!$Rs_table){
		...
		echo "<meta http-equiv='refresh' content='1;url=board01_view.htm?No=$No&Sub_No=$Sub_No'>"; 
	}



}ELSE{
		echo "<meta http-equiv='refresh' content='0;url=board01_list.htm?Sub_No=$Sub_No'>"; 
}
 ?>

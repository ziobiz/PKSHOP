						...
						<td valign='top'>
							...
							<?}?>
								...
								<input type="hidden" name="Cont_type" value="AUTO"> -->
								 ...
								 <!-- 카타고리 -->
								 <tr>
									<td width='170' height='35' align='right'>* 카타고리&nbsp;</td>
									<td width='20'></td>
									<td width='610' align="left">
										&nbsp;<? include './select_board.php';?>
										&nbsp;&nbsp;<input type='checkbox' name='B_Title' <? if($B_Title==1){?>checked<?}?> value='1' style='border:0;background-color: #FFFFFF ;'>공지글
										&nbsp;&nbsp;<input type='checkbox' name='Secret' <? if($Secret==1){?>checked<?}?> value='1' style='border:0;background-color: #FFFFFF ; ' >비밀글
									</td>
								</tr>								
								...
								<!-- 비밀번호 -->
								 <tr>
									...
									<td width='20'></td>
									<td width='610' align="left">&nbsp;<input type='password' name='Pass' onKeyDown="Cal_Key_num++;"  size='30' ></td>
								</tr>								
								<tr><td colspan='3' height='1' bgcolor='<?=$line_w_back?>'></td></tr>
								...
								<tr>
									...
									<td width='20'></td>
									<td width='610' align="left">&nbsp;<input type='text' name='Email' value='<?=$Email?>' size='60'  ></td>
								</tr>
								<tr><td colspan='3' height='1' bgcolor='<?=$line_w_back?>'></td></tr>

								<!-- 사이트주소 -->
								<tr>
									<td height='35' align='right'>사이트주소&nbsp;</td>
									<td width='20'></td>
									<td width='610' align="left">&nbsp;<input type='text' name='Homepage' value='<?=$Homepage?>' size='60'></td>
								</tr>
								<tr><td colspan='3' height='1' bgcolor='<?=$line_w_back?>'></td></tr>
								
								<!-- 제 목 -->
								<tr>
									<td height='35' align='right'>* 제 목&nbsp;</td>
									<td width='20'></td>
									<td width='610' align="left">&nbsp;<input type='text' name='Title' value='<?=$Title?>' size='75'></td>
								</tr>
								<tr><td colspan='3' height='1' bgcolor='<?=$line_w_back?>'></td></tr>
								...
								<!-- 파 일-->
								<tr>
									<td height='35' align='right'><?if($Sub_No=='2'){?>로 고<?}else{?>파 일<?}?>&nbsp;</td>
									<td width='20'></td>
									<td width='610' align="left">

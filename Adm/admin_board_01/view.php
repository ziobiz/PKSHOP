					...
					<tr>
						<td valign='top'>
							...
							<table width='<?=$T_width?>' height='<?=$T_height?>'  border='0' cellpadding='0' cellspacing='0'>
								<tr><td colspan='2' height='10' align="right"><?=$Email?></td></tr>
								...
								<tr bgcolor='<?=$bg_back?>'>
									<td height='22' align="left">&nbsp;&nbsp;&nbsp;조회수 : <?=$Cnt?></td>
									<td align='right'>작성일 : <?=$Date_time?>&nbsp;&nbsp;&nbsp;</td>
								</tr>
								<tr>
									<td  height='22' bgcolor='<?=$bg_back?>' align="left">&nbsp;&nbsp;&nbsp;작성자 : <?=$Name?></td>
									<td align='right' bgcolor='<?=$bg_back?>'>아이피 : <?=$Ip?>&nbsp;&nbsp;&nbsp;</td>
								</tr>
								<?if($Files!='' or $Files1!='' or $Homepage!=''){?>
								<tr bgcolor='<?=$bg_back?>'>
									<td height='22' align="left">&nbsp;&nbsp;&nbsp;<?=$Files?>&nbsp;<?=$Files1?></td>
								...
								<tr>
									...
									<td  align='right'>
										...
										<a href='write.php?No=<?=$No?>&Sub_No=<?=$Sub_No?>&mode=edit&page=<?=$page?>' onfocus='this.blur()' >글수정</a>&nbsp;&nbsp;
...
<!-- 글 수정 하기 레이어 실행 -->
<div id="edit" style="position:absolute; width:200px; height:80px; z-index:1; left: 420px; top: 280px; visibility: hidden; border: 1px solid black; background: white">
...
<!-- 글 삭제 하기 레이어 실행 -->
<div id="Del" style="position:absolute; width:200px; height:80px; z-index:1; left: 420px; top: 280px; visibility: hidden; border: 1px solid black; background: white"> 
	<table border=0 cellspacing=0 cellpadding=3 width=200>

...
function check_spon2(type){
   ...
   var frm  = document.join_form;
	...
	member_type = type;
	 if (frm.h_username.value != "" && type == "h")
	{
               ...
               //alert(httpRequest.responseText);
				if (member_type == "c")
				{
						  if(httpRequest.responseText == 0 || httpRequest.responseText == 2)
						{
								...
								frm.cidflag.value = "y";  
								document.getElementById('sponsearchc').innerHTML = "<span>&nbsp;&nbsp;&nbsp;<img src='img/accept.gif' width='20' height='18' border='0' /><img src='image/white_spacer.gif' width='5' height='2' border='0'><font color='#003909'> <b>Verified!  </b></font></span>";
				...
				{	
					//alert(httpRequest.responseText);
						...
						{			
								...
								frm.hidflag.value = "y";  
								//document.getElementById('sponsearchh').innerHTML = "<span>&nbsp;&nbsp;&nbsp;<img src='img/accept.gif' width='20' height='18' border='0' /><img src='image/white_spacer.gif' width='5' height='2' border='0'><font color='#003909'> <b>Verified!  </b></font></span>";
							    frm.sponsearchh.value= httpRequest.responseText;
						  } 

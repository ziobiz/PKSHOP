...
//editor 위치(ie9 버전을 위한), upfile_ok.php도 수정됨
//$url=$_SERVER["HTTP_HOST"];
//$url_editor=$url."/admin/admin_board_01/data";
$url_editor="http://www.pangpangs.com/Adm/admin_board_01/data";


$Board_Title = "팝업관리"; //게시판이름
...
$email_part="<img src=/shop/admin/admin_board_01/img/send_mail.gif border=0 align=middle>";

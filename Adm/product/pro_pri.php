...
function go_select(i) {
	...
	document.form.action="pro_pri.php";
...
$query = "SELECT code,code1,code2,code3,title,currnum,pricec,rank_r,code4,order4,No FROM $shop_goods WHERE theme_n='n' ORDER BY rank_r asc,signdate DESC";
$DB->get($query,$rs,$rn);
$total_record =$rn;
$article_num=1;
$curr_i=1;
...
?>
								<tr align="center"> 
									...
									<td width="332" height="26">
										<a href="pro_info.php?sel_theme=n&code=<?=$code?>&No=<?=$No?>"><?=$title?></a>
									</td>

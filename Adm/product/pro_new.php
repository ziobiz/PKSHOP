...
function go_select(i) {
	...
	document.form.action="pro_new.php";
	document.form.submit();
}

function go_del() {
	document.form.action="pro_theme_del.php?theme=n";
	document.form.submit();
}
...
function go_rank(num) {
	...
	document.form.action="pro_theme_rank.php?theme=n&rank_num="+num;
	document.form.submit();
}
...
function go_add() {
	...
	document.form.action="pro_theme_add.php?theme=n";
	document.form.submit();
}
function all_chk() {
...
$query = "SELECT cate1,code1 FROM $shop_cate WHERE code1<>'01' and code2='00' and code3='00' and code4='00' ORDER BY rank";
$DB->get($query,$rs,$rn);
...
<?
$query = "SELECT code,title,theme_n FROM $shop_goods WHERE (code1='$sel_code1' or code2='$sel_code2' or code3='$sel_code3' or code4='$sel_code4') and soldout<>'Y' ORDER BY signdate DESC";
$DB->get($query,$rs,$rn);
...
?>
										<option value="<?=$theme_n.$g_code?>" <?=$oselect?>><?=$title?></option>
...
$query = "SELECT code,code1,code2,code3,title,currnum,pricec,rank_n,code4,order4 FROM $shop_goods WHERE theme_n='n' ORDER BY rank_n asc,signdate DESC";
...
?>
									...
									<tr align="center"> 
										...
										<td width="332" height="26">
											<a href="pro_info.php?sel_theme=n&code=<?=$code?>"><?=$title?></a>
										</td>

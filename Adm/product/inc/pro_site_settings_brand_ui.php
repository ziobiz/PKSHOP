...
adm_ui_field_row('약관 회사명', '<input type="text" name="agree_company_name" value="' . adm_ui_h($s['agree_company_name']) . '" class="pg-input pg-input--w-title"><p class="pg-field-hint">agree.php 내 회사명 치환</p>', false, true);

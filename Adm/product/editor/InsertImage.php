...
<body bgcolor="#dedede">
<form name="TableForm" method="post" action="InsertImageOk.asp" enctype="multipart/form-data">
		...
		<TD>
			<TABLE WIDTH=100% BORDER=0 CELLSPACING=0 CELLPADDING=0>
				...
				<TR>
					<TD>
						<br>
						<input type="submit" value="확인" style='font-family:verdana;font-size:8pt' onfocus='this.blur()'>

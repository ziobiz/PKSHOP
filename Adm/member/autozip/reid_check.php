...
{ ?>    
          ...
          <td style=padding-top:10;padding-bottom:10> <BR><BR><div align="center"><b><font color='#6699FF'><?=$id?></font></b><font color=black>는(은) 없는 아이디 입니다. </div></td>
 ...
 <!--  <tr> 
	...
	<?	 }else{ ?>
          ...
          <td style=padding-top:10;padding-bottom:10><BR><div align="center"><b><font color='#6699FF'><?=$id?></font></b><font color=black>는(은) 등록된 아이디 입니다.<BR>추천인 아이디로 사용하실수 있습니다.<BR><img src="./images/join01_but01.gif" onclick="opener.document.form.passwd.focus();opener.document.form.recommend3.value='ok';window.close()" style="cursor:hand"></div></td>

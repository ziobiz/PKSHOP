...
function Memo_del(No,Title,page)
	{
		url="comm_del.php?No="+No+"&Title="+Title+"&page="+page;	//팝업창 파일이름 및 경로
		wi="200"		//팝업창 가로 사이즈
		hi="80"		//팝업창 세로 사이즈
...
function Memo_del1(No,Title,page)
	{
		url="comm_del1.php?No="+No+"&Title="+Title+"&page="+page;	//팝업창 파일이름 및 경로
		wi="200"		//팝업창 가로 사이즈
		hi="80"		//팝업창 세로 사이즈
		li="420"		//팝업창 가로 위치(가로 또는 세로 위치 값이 없을시 기본 위치에 팝업창이 뜸)
		ti="480"		//팝업창 세로 위치(가로 또는 세로 위치 값이 없을시 기본 위치에 팝업창이 뜸)

...
//데이터베이스에 입력값을 삽입한다
	$query="INSERT INTO $member_p";
	$query=$query."(";
	$query=$query."no,id,name,jumin,sex,email,handphone,zip,address,info,signdate,Fname,admail,adsms";
	$query=$query.")";
	$query=$query."VALUES";
	$query=$query."(";
	$query=$query."'','$id','$name','$jumin','$sex','$email','$handphone','$zipcorde','$address','$info','$signdate','$Fname','$admail','$adsms'";
	$query=$query.")";

...
{ ?>    
 ...
 <!--  <tr> 
	...
	<?	 }else{ ?>
          ...
          <td style=padding-top:10;padding-bottom:10><BR><div align="center"><b><font color='#6699FF'><?=$id?></font></b><font color=black>는(은) 사용가능한 아이디 입니다.<BR><BR><img src="./images/join01_but01.gif" onclick="opener.document.join.passwd.focus();window.close()" style="cursor:hand"></div></td>

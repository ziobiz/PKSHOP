...
<div id="footer_2">
	    <div class="inner">
	        <div class="item-0 item-1">
	            ...
	            <p class="p1">pentakleva@gmail.com</p>
	        </div>
	        <div class="item-0 item-1">
	            <p class="text-tit">銀行口座情報</p>
				<div class="div01">	                
	                <p style="font-size:12px;">123-124-16576 / Alpha Bank</p>
	            </div>
				<div class="div01">	                
					<p style="font-size:12px;">Holder: Pentakleva Limited</p>
	            </div>
	        ...
	        <div class="item-0 item-4">
	            ...
	            <p class="p1">会社住所: Spyrou Lamprou 5, Flat/Office 101. 1082, Nicosia, Cyprus</p>
	...
	<div id="footer">
	    <div class="footer_top">
	        ...
	        <a href="../member/agree.php">規約と条件s</a>
	        <div class="footer_top_bar"></div>
	    ...
	    <div class="footer_middle">
	        ...
	        <div class="footer_middle_box">
	            ...
	            <p class="company_text"><span>会社名</span>&nbsp;&nbsp;Pentakleva Limited
	                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>代表取締役</span>&nbsp;&nbsp;Annita Christodoulou&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span></span>
	                <span>会社住所</span>&nbsp;&nbsp; Spyrou Lamprou 5, Flat/Office 101. 1082, Nicosia, Cyprus&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                <!-- <span>전화</span>&nbsp;&nbsp;1577-9761 -->
	                <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span>팩스</span>&nbsp;&nbsp;041-622-9776<br> -->
	                 <!--<span>Business registration number.</span>&nbsp;&nbsp;505-10-14443 -->
	    ...
	    <div class="footer_bottom">
	        <div class="footer_bottom_inner">
	            <p class="copy">Copyright (C) Pentakleva Limited, All Rights Reserved.</p>
	        </div>
	    </div>
	</div>
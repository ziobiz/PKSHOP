...
//    include "../../Adm/common/dbconn.php";
  ...
  $query = "SELECT passwd,c_name,c_email,tel,c_hand,c_point,dis,dis1,company,recommend,comnum,etc1,etc2,cont,solar,admail,adsms from $member_table WHERE c_id='$id'";


  $DB->get($query,$custs,$custn);

$real_pass	= $custs[0]['passwd'];
$name		= $custs[0]['c_name'];
$jumin		= $custs[0]['jumin'];
$sex		= $custs[0]['sex'];
$job		= $custs[0]['job'];
$email		= $custs[0]['C_EMAIL'];
$handphone		= $custs[0]['C_HAND'];
$zipcorde	= $custs[0]['zip'];
$address	= $custs[0]['address'];
$info		= $custs[0]['info'];
$point		= $custs[0]['c_point'];
$dis		= $custs[0]['dis'];
$dis1		= $custs[0]['dis1'];
$company	= $custs[0]['company'];
$recommend	= $custs[0]['recommend'];
$comnum		= $custs[0]['comnum'];
$etc1		= $custs[0]['etc1'];
$etc2		= $custs[0]['etc2'];
$cont		= $custs[0]['cont'];
$solar		= $custs[0]['solar'];
$admail		= $custs[0]['admail'];
$adsms		= $custs[0]['adsms'];

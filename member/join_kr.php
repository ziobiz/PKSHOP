	...
	<div id="content">
		...
		<input type="hidden" name="hidflag" value="n">
			...
			<div class="write_btn_box">
				<input type="button" value="Sign up / 가입" class="cart_btn04" onClick="signup_ok();">&nbsp;
				<input type="button" value="Cancle / 취소" class="cart_btn01" onclick="location.href='./agree.php'">
			</div>
			</form>

		...
		<div class="content_inner">
			...
			<div class="login_inner">
				...
				<div class="login_box">
					...
					<input type="checkbox" name="idcheck" onClick="confirmSave(this)"> <span style="font-face:nanum Gothic; font-size:14px; color:#c3070b">ID SAVED (ID 기억하기)</span>
					</div>
				</div>
				</form>
				<!-- 회원로그인 종료 -->
...
<div class="sp5"></div>
							<td width="40%"><a href="agree.php" style="background:#c3070b; color: #fff;padding: 8% 12%;border-radius: 15px;">Sign up / 회원가입</a></td>
						</tr>
					</table>
				</div>
			</div>

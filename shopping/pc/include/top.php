...
<!-- 				</div> -->
		...
		<div class="header_inner pc_hide" style="position:relative;">
			<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);"><a href="../main/main.html"><img src="../images/m_logo.png" class="m_logo"></a></div>
...
//		echo $query_tt;
		...
		$total_record_tt = mysql_num_rows($result_tt);
//		echo $total_record_tt;
		//echo "$total_record_tt";
		//exit;

		for($i_tt  = 0; $i_tt  < $total_record_tt ; $i_tt ++) {
			$menu_code1 = mysql_result($result_tt ,$i_tt ,0);
			$menu_title1 = mysql_result($result_tt ,$i_tt ,1);
...
<div id="gnb" class="pc_hide">
	<div class="gnb_inner">
		<div class="click_logo_box">
			<div class="nav_logo"><img src="../images/logo_2.png" style="width: 100px;float: left;"></div>

    ...
    <table width="637" height="306" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table width="300" border="0" cellspacing="3" cellpadding="0">
          <tr>
            <!-- 지불요청 버튼--><td width="90"><a href=AGS_pay.php><img src="image/demo_btn_01.gif" border="0"></a></td>
            <td width="210"><img src="image/demo_img_01.gif"></td>
          </tr>
          <tr>
            <!-- 취소요청 버튼--><td><a href=AGS_cancel.php><img src="image/demo_btn_02.gif" border="0"></a></td>

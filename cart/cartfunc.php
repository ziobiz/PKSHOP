...
function totCount_selected()
{
	...
	if($session_cart_selected!="") {
		$tmpArray=explode(";",$session_cart_selected);
		return count($tmpArray);
	} else return 0;
}
...
function delCart_selected($index)
{
	...
	$_SESSION["session_cart_selected"]=$session_cart_selected;
}
